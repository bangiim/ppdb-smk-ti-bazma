                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <center>
                                    <img src="./img/logos/logo-smk-ti-bazma-long.png" alt="main_logo" width="70%">
                                </center>
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="flex flex-col mb-3">
                                            <input type="email" name="email" class="form-control form-control-lg" aria-label="Email" placeholder="email">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-dark h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://smktibazma.sch.id/static/media/masjid.d157934d98cee11f144c.jpg');
              background-size: cover;">
                                <span class="mask bg-gradient-dark opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"PPDB SMK TI BAZMA"</h4>
                                <p class="text-white position-relative">Tahun Pelajaran 2024/2025</p>
                            </div>
                        </div>
                    </div>
                </div>
